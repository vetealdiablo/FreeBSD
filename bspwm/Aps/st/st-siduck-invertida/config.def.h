...
static char *font2[] = {
    ...
    "SauceCodePro NF Black:pixelsize=14:antialias=true:autohint=true",
    "SauceCodePro NF:pixelsize=14:antialias=true:autohint=true",
    "Hack Nerd Font:pixelsize=14:antialias=true:autohint=true",
    "NotoSans NF:pixelsize=14:antialias=true:autohint=true",
    "Iosevka NF:pixelsize=14:antialias=true:autohint=true",
    "JetBrainsMonoNL NF:pixelsize=14:antialias=true:autohint=true",
    "JetBrainsMono NF:pixelsize=14:antialias=true:autohint=true",
    "BitstromWera Nerd Font:pixelsize=14:antialias=true:autohint=true",
    "BitstromWera Nerd Font Mono:pixelsize=14:antialias=true:autohint=true",
    "FiraCode Nerd Font:pixelsize=14:antialias=true:autohint=true",
    "DejaVuSansM Nerd Font:pixelsize=14:antialias=true:autohint=true"
};
...
static const char *colorname[] = {
    /* 8 colores normales */
    "#000000", /* color0: negro */
    "#AB2B28", /* color1: rojo oscuro */
    "#a6e22e", /* color2: verde oscuro */
    "#F1BB16", /* color3: amarillo oscuro */
    "#4169e1", /* color4: azul oscuro */
    "#ed3ea3", /* color5: magenta oscuro */
    "#ae81ff", /* color6: cian oscuro */
    "#f8f8f2", /* color7: blanco oscuro */

    /* 8 colores brillantes */
    "#272822", /* color8: negro brillante */
    "#FF6E6E", /* color9: rojo brillante */
    "#D0F58B", /* color10: verde brillante */
    "#F9E18A", /* color11: amarillo brillante */
    "#7998ff", /* color12: azul brillante */
    "#FF79C6", /* color13: magenta brillante */
    "#E1BFFF", /* color14: cian brillante */
    "#FFFFFF", /* color15: blanco brillante */
